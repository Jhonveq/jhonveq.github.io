...
const Contact = () => {
  return (
    <div id='contact' className='max-w-[1040px] m-auto md:pl-20 p-4 py-16'>
        ...
        <form action="https://getform.io/f/lakmkrea" method='POST' encType='multipart/form-data'>
            <div className='flex flex-col gap-4 w-full py-2'>
                ...
                <div className='flex flex-col'>
                    ...
                    <input  type="number" name='phone' className='border-2 rounded-lg p-3 flex border-gray-300'/>
                </div>
                ...
                <div className='flex flex-col py-2'>
                    ...
                    <textarea className='border-2 rounded-lg p-3 flex border-gray-300' type="email" name='message' rows='10' ></textarea>
                </div>
